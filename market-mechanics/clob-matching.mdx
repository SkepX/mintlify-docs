---
title: 'CLOB & Matching'
description: 'How the orderbook executes trades on belief prices'
---

Ascend uses a Central Limit Order Book (CLOB) for price discovery and trade execution. Traders place bids and offers at specific belief prices, and the matching engine pairs compatible orders.
...
The orderbook is a list of all open orders, organized by price and time.

**Bid side:** Orders to go LONG (buy) at a specific belief price or lower
**Ask side:** Orders to go SHORT (sell) at a specific belief price or higher

**Example orderbook for a Fed rate cut market:**
...
The best bid is 63%. The best ask is 64%. The spread is 1%.

If you want to go LONG immediately, you pay 64% (the best ask). If you want to go SHORT immediately, you receive 63% (the best bid).
...
This continuous process is how belief prices evolve in real time as traders express their views.
