...
description: 'How funding keeps traded prices aligned with external belief signals'
---
...
On Ascend, funding transfers value between LONG and SHORT positions based on how far the Mark Price has diverged from the Index Price. This creates a natural incentive for prices to stay anchored to external belief signals.
...
|-------|-------------------|
| Index Price | External reference from oracles. The "true" belief. |
