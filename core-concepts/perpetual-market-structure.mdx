...
Belief prices update continuously based on trading activity and oracle inputs. The market is always open.
...
Traders place bids and offers around belief prices. Trades execute directly between participants. There is no AMM, no liquidity pool, no protocol-owned inventory.
...
Perpetual markets need a way to stay anchored to reality. Without expiry forcing convergence, prices could drift from true belief levels.

Ascend solves this with two mechanisms:

<Tabs>
  <Tab title="Oracle Anchoring">
    Belief prices are sourced from external prediction markets and oracles. The **Index Price** represents the best available estimate of the true probability at any moment.
...
These mechanisms allow perpetual markets to track belief accurately without requiring forced settlement.
