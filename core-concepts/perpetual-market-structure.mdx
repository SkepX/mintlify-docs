...
<Tabs>
  <Tab title="Oracle Anchoring">
    ...
    Ascend anchors its pricing to external prediction markets like Kalshi and Polymarket, where price discovery occurs.
  </Tab>
  <Tab title="Funding">
...
With perpetual structure, prediction markets work like trading venues, not betting slips.

---

## The Foundation

Everything else in the system depends on perpetual structure.
