...
Your PnL comes from these movements. If you go LONG at 55% and the price rises to 68%, you profit. If it drops to 45%, you'd have unrealized losses. The final event resolution matters for settlement, but you can trade in and out based on probability movement alone.
