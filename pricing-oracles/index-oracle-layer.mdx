...
Ascend does not invent probabilities. Every belief price on the platform is anchored to external sources through the Index Price.
...
<Tabs>
  <Tab title="Event Markets">
    ...
    **Example:** A market on "Will the Fed cut rates in March?" might pull prices from both Kalshi and Polymarket, where thousands of traders have already expressed their views.
  </Tab>
...
| Data | Purpose |
|------|---------|
| Belief percentage | The actual probability (e.g. 62%) |
...
- Each oracle provides a belief percentage and timestamp
